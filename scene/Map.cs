...
public partial class Map : TileMapLayer
{
    ...
    public override void _Ready()
    {
        ...
        {
            // 一系列用轴向坐标求得的邻接点的地格坐标
            AxialCoor axialCoor = _hexAxialCoors[i];
            AxialCoor n1 = new AxialCoor(axialCoor.Q + 1, axialCoor.R);
            AxialCoor n2 = new AxialCoor(axialCoor.Q + 1, axialCoor.R - 1);
            AxialCoor n3 = new AxialCoor(axialCoor.Q, axialCoor.R - 1);
            AxialCoor n4 = new AxialCoor(axialCoor.Q - 1, axialCoor.R);
            AxialCoor n5 = new AxialCoor(axialCoor.Q - 1, axialCoor.R + 1);
            AxialCoor n6 = new AxialCoor(axialCoor.Q, axialCoor.R + 1);
    ...
    public void DetectAttackIcon(Vector2I coor)
    {
        ...
        List<AxialCoor> neighbors = axialCoor.GetNeighborCoor(_hexAxialCoors);
